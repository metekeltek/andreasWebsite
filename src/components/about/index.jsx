...
<AboutSection>
  <div>
    <img src={kid2} width={500} height={700} style={{marginTop:0}}/>
  </div>
  <div>
    <img src={kid1} width={500} height={700} style={{marginTop:0}}/>
  </div>
</AboutSection>

<SubTitle><b className="text-primary">Bei mir sollt Ihr Euch beide wohl fühlen!</b></SubTitle>
    <img src={kid4} width={700} height={500} style={{marginTop:0, marginLeft: "auto", marginRight:"auto", display:"block"}}/>
    ...
    <img src={kid5} width={350} height={550} style={{marginTop:0, marginLeft: "auto", marginRight:"auto", display:"block"}}/>
    ...
    <img src={kid1} width={350} height={550} style={{marginTop:0, marginLeft: "auto", marginRight:"auto", display:"block"}}/>
